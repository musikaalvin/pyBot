...
<img src="utils/bot_image.jpg" alt="pyBot" width="260">

</div>

pyBot is a WhatsApp MD bot built on top of the **Baileys** library.  
...
<a href="https://github.com/musikaalvin/pyBot/fork" target="_blank">
...
> This creates your own copy of `pyBot` under your GitHub account.
...
```bash
git clone https://github.com/musikaalvin/pyBot.git
cd pyBot
```
...
<a href="https://whatsapp.com/channel/0029VbCl7fQCHDyiFOl5vq0S" target="_blank">
...
- **pyLord** – Main developer & maintainer  
...
<a href="https://buymeacoffee.com/pylord" target="_blank">
